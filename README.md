...
-   **Frontend**: React (created with `create-react-app`). Uses `fetch` to communicate with the backend.
-   **Backend**: FastAPI. Enables CORS for development. Stores details in a simple Python list.
